...
![types of data graphic](https://geoservices.leventhalmap.org/docs/workshops/media/img/types_data.png)
...
Here are some examples of common spatial raster data.
 ...
 ![example of raster data](https://geoservices.leventhalmap.org/docs/workshops/media/img/satellite.png) <br>
 *Example of raster data: satellite and aerial imagery*

![example of raster data](https://geoservices.leventhalmap.org/docs/workshops/media/img/map.png) <br>
 *Another example of raster data: scans of historical maps*

 ![third example](https://geoservices.leventhalmap.org/docs/workshops/media/img/shaded-relief.png) <br>
...
![csv](https://geoservices.leventhalmap.org/docs/workshops/media/img/csv.png)
...
![mass map](https://geoservices.leventhalmap.org/docs/workshops/media/img/Mass_map.png)
