...
![types of data graphic](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/types_data.png)
...
Here are some examples of common spatial raster data.
 ...
 ![example of raster data](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/satellite.png) <br>
 *Example of raster data: satellite and aerial imagery*

![example of raster data](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/map.png) <br>
 *Another example of raster data: scans of historical maps*

 ![third example](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/shaded-relief.png) <br>
...
![csv](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/csv.png)
...
![mass map](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/img/Mass_map.png)
