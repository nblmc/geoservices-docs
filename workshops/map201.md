...
#### Merging Data
![merges](https://geoservices.leventhalmap.org/docs/media/img/pngmerges.png)
<!-- tabs:start -->
#### ** Example **
...
![bpl_dataframe](https://geoservices.leventhalmap.org/docs/media/img/pngbpl_dataframe.png)
