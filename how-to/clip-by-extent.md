...
![download buildings](/media/img/download-buildings.png)

3. Download the Neighborhood boundaries on the Analyze Boston page by also clicking "Shapefile"
![download neighborhoods](/media/img/download-neighborhoods.png)

and then selecting "Download" <br>
![Analyze Boston download button](/media/img/download-ab.png)
...
![Add data to QGIS](/media/gif/add-data.gif)
...
![Turn off layer](/media/gif/turn-off-layer.gif)
...
![Open attribute table](/media/gif/open-attribute-table.gif)
...
![highlight](/media/img/highlight.png)
...
![export selected](/media/img/export-selected.png)
...
![save](/media/img/save.png)

9. Keep "Add saved file to map" CHECKED <br>
![add to map](/media/img/add-to-map.png)
...
![remove layer](/media/gif/remove-layer.gif)
...
![toolbox](/media/img/toolbox.png)


2). Select **Vector Selection → Extract by location** <br><br>
![extract by location](/media/img/extract-location.png)
