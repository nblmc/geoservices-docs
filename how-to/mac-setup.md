...
### A note about OSGeo4Mac tap formulae {docsify-ignore}
...
### Recommended packages to install with Homebrew {docsify-ignore}
...
### Recommended packages to install with pip {docsify-ignore}
...
### From the app bundle {docsify-ignore}
...
### From Homebrew Cask {docsify-ignore}
