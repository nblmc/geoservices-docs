...
> [Why do we we use NHGIS to download census data for mapping?](/considerations?id=picking-a-service "Why do we we use NHGIS to download census data for mapping?")
