...
![Add data to QGIS](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/gif/add-data.gif)
...
![Turn off layer](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/gif/turn-off-layer.gif)
...
![Open attribute table](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/gif/open-attribute-table.gif)
...
![remove layer](https://geoservices.leventhalmap.org/docshttps://geoservices.leventhalmap.org/docs/media/gif/remove-layer.gif)
